...
Please refer to the official Hekas [bug bounty program](https://immunefi.com/bounty/hekas/)
...
- Use the Hekas [bug bounty program](https://immunefi.com/bounty/hekas/) on Immunefi to disclose all vulnerabilities,
...
- For `High` and `Critical`:
    1. Patches are prepared for supported releases of Hekas in a
    ...
    5. A week (or less) after the security vulnerability has been patched on Hekas,
...
including but not limited to Hekas,
...
The Hekas Security Team is constantly being monitored.
If you need to reach out to the team directly,
please reach out via email: [security@hekasseed.com](mailto:security@hekasseed.com)
