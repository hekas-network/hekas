...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*hekastypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*hekastypes.TxResult, error)
...
type Backend struct {
	...
	indexer             hekastypes.EVMTxIndexer
}
...
func NewBackend(
	...
	chainID, err := hekastypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
