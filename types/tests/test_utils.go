...
var (
	...
	UhekasDenomtrace = transfertypes.DenomTrace{
		Path:      "transfer/channel-0",
		BaseDenom: "ahekas",
	}
	UhekasIbcdenom = UhekasDenomtrace.IBCDenom()
	...
	AhekasDenomtrace = transfertypes.DenomTrace{
		Path:      "transfer/channel-0",
		BaseDenom: "ahekas",
	}
	AhekasIbcdenom = AhekasDenomtrace.IBCDenom()
)
