...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "hekas_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "HEKAS_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Hekas_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "hekas_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "hekas_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "hekas_hekas_9898-1", true, nil,
		},
		{
			"invalid epoch, undefined", "hekas_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "hekas_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
