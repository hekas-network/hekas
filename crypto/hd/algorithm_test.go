...
import (
	...
	cryptocodec "github.com/hekas-network/hekas/crypto/codec"
	enccodec "github.com/hekas-network/hekas/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("hekas", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, hekastypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, hekastypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := hdwallet.MustParseDerivationPath(hekastypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of Hekas implementation
	...
	// Equality of Eth and Hekas implementation
	...
	// Inequality of wrong derivation path of Eth and Hekas implementation
