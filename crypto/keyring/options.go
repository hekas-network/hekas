...
import (
	...
	"github.com/hekas-network/hekas/ledger/ledger"
)

// AppName defines the Ledger app used for signing. Hekas uses the Ethereum app
...
var (
	...
	// LedgerDerivation defines the Hekas Ledger Go derivation (Ethereum app with EIP-712 signing)
	LedgerDerivation = ledger.HekasLedgerDerivation()
