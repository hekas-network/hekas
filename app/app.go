...
import (
	...
	ethante "github.com/hekas-network/hekas/app/ante/evm"
	"github.com/hekas-network/hekas/encoding"
	"github.com/hekas-network/hekas/ethereum/eip712"
	srvflags "github.com/hekas-network/hekas/server/flags"
	hekastypes "github.com/hekas-network/hekas/types"
	"github.com/hekas-network/hekas/x/evm"
	evmkeeper "github.com/hekas-network/hekas/x/evm/keeper"
	evmtypes "github.com/hekas-network/hekas/x/evm/types"
	"github.com/hekas-network/hekas/x/feemarket"
	feemarketkeeper "github.com/hekas-network/hekas/x/feemarket/keeper"
	feemarkettypes "github.com/hekas-network/hekas/x/feemarket/types"

	// unnamed import of statik for swagger UI support
	_ "github.com/hekas-network/hekas/client/docs/statik"

	"github.com/hekas-network/hekas/app/ante"
	"github.com/hekas-network/hekas/x/claims"
	claimskeeper "github.com/hekas-network/hekas/x/claims/keeper"
	claimstypes "github.com/hekas-network/hekas/x/claims/types"
	"github.com/hekas-network/hekas/x/epochs"
	epochskeeper "github.com/hekas-network/hekas/x/epochs/keeper"
	epochstypes "github.com/hekas-network/hekas/x/epochs/types"
	"github.com/hekas-network/hekas/x/erc20"
	erc20client "github.com/hekas-network/hekas/x/erc20/client"
	erc20keeper "github.com/hekas-network/hekas/x/erc20/keeper"
	erc20types "github.com/hekas-network/hekas/x/erc20/types"
	"github.com/hekas-network/hekas/x/incentives"
	incentivesclient "github.com/hekas-network/hekas/x/incentives/client"
	incentiveskeeper "github.com/hekas-network/hekas/x/incentives/keeper"
	incentivestypes "github.com/hekas-network/hekas/x/incentives/types"
	"github.com/hekas-network/hekas/x/inflation"
	inflationkeeper "github.com/hekas-network/hekas/x/inflation/keeper"
	inflationtypes "github.com/hekas-network/hekas/x/inflation/types"
	"github.com/hekas-network/hekas/x/recovery"
	recoverykeeper "github.com/hekas-network/hekas/x/recovery/keeper"
	recoverytypes "github.com/hekas-network/hekas/x/recovery/types"
	revenue "github.com/hekas-network/hekas/x/revenue/v1"
	revenuekeeper "github.com/hekas-network/hekas/x/revenue/v1/keeper"
	revenuetypes "github.com/hekas-network/hekas/x/revenue/v1/types"
	"github.com/hekas-network/hekas/x/vesting"
	vestingkeeper "github.com/hekas-network/hekas/x/vesting/keeper"
	vestingtypes "github.com/hekas-network/hekas/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/hekas-network/hekas/x/ibc/transfer"
	transferkeeper "github.com/hekas-network/hekas/x/ibc/transfer/keeper"
...
func init() {
	if DefaultNodeHome == "" {
		...
		DefaultNodeHome = filepath.Join(userHomeDir, ".hekas")
	}
	// manually update the power reduction by replacing micro (u) -> atto (a) hekas
	sdk.DefaultPowerReduction = hekastypes.PowerReduction
...
var (
	_ servertypes.Application = (*Hekas)(nil)
	_ ibctesting.TestingApp   = (*Hekas)(nil)
)

// Hekas implements an extended ABCI application. It is an application
...
func NewHekas(
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		appCodec, keys[authtypes.StoreKey], app.GetSubspace(authtypes.ModuleName), hekastypes.ProtoAccount, maccPerms, sdk.GetConfig().GetBech32AccountAddrPrefix(),
	)
...
func (app *Hekas) Name() string { return app.BaseApp.Name() }

func (app *Hekas) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := ante.HandlerOptions{
		Cdc:                    app.appCodec,
		AccountKeeper:          app.AccountKeeper,
		BankKeeper:             app.BankKeeper,
		ExtensionOptionChecker: hekastypes.HasDynamicFeeExtensionOption,
...
func (app *Hekas) setupUpgradeHandlers() {
