...
import (
	...
	hekasapp "github.com/hekas-network/hekas/app"
	"github.com/hekas-network/hekas/types"
	"github.com/hekas-network/hekas/utils"
)

var DefaultTestingAppInit func() (ibcgotesting.TestingApp, map[string]json.RawMessage) = hekasapp.SetupTestingApp
...
func SetupWithGenesisValSet(t *testing.T, valSet *tmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount, chainID string, balances ...banktypes.Balance) ibcgotesting.TestingApp {
	...
	app.InitChain(
		abci.RequestInitChain{
			...
			ConsensusParams: hekasapp.DefaultConsensusParams,
