...
// ChainIDPrefix defines the default chain ID prefix for Hekas test chains
var ChainIDPrefix = "hekas_9898-"
...
func NewTestChain(t *testing.T, coord *ibcgotesting.Coordinator, chainID string) *ibcgotesting.TestChain {
	...
	amount := sdk.TokensFromConsensusPower(1, hekastypes.PowerReduction)
