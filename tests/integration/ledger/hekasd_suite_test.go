...
import (
	...
	"github.com/hekas-network/hekas/tests/integration/ledger/mocks"
	...
	clientkeys "github.com/hekas-network/hekas/client/keys"
	hekaskeyring "github.com/hekas-network/hekas/crypto/keyring"
...
func (suite *LedgerTestSuite) SetupHekasApp() {
...
func (suite *LedgerTestSuite) hekasAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = hekaskeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = hekaskeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = hekaskeyring.CreatePubkey
		options.LedgerAppName = hekaskeyring.AppName
		options.LedgerSigSkipDERConv = hekaskeyring.SkipDERConversion
	}
}
