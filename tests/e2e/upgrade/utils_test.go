...
// TestHekasVersionsLess tests the HekasVersions type's Less method with
// different version strings
func TestHekasVersionsLess(t *testing.T) {
	var version HekasVersions
...
// TestHekasVersionsSwap tests the HekasVersions type's Swap method
func TestHekasVersionsSwap(t *testing.T) {
	var version HekasVersions
	value := "v9.1.0"
...
// TestHekasVersionsLen tests the HekasVersions type's Len method
func TestHekasVersionsLen(t *testing.T) {
	var version HekasVersions = []string{"v9.1.0", "v10.0.0"}
