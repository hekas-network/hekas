...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "hekas.inflation.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "hekas.inflation.v1.V2Params")
}

func init() { proto.RegisterFile("hekas/inflation/v1/genesis.proto", fileDescriptor_1cb8eee530db1235) }
