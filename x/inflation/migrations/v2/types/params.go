...
var (
	...
	DefaultExponentialCalculation = V2ExponentialCalculation(types.DefaultExponentialCalculation)
	DefaultInflationDistribution  = V2InflationDistribution(types.DefaultInflationDistribution)
)
