...
var (
	...
	DefaultExponentialCalculation = ExponentialCalculation{
		A:             sdk.NewDec(int64(5_600_000)),
		R:             sdk.NewDecWithPrec(5, 1),
		C:             sdk.NewDec(int64(840_000)),
		BondingTarget: sdk.NewDecWithPrec(66, 2),
		MaxVariance:   sdk.ZeroDec(),
	}
	DefaultInflationDistribution = InflationDistribution{
		StakingRewards:  sdk.NewDecWithPrec(716_666_667, 9),
		UsageIncentives: sdk.NewDecWithPrec(15, 2),
		CommunityPool:   sdk.NewDecWithPrec(133_333_333, 9),
	}
)
