...
func CalculateEpochMintProvision(
	...
	// Multiply epochMintProvision with power reduction (10^18 for hekas) as the
	// calculation is based on `hekas` and the issued tokens need to be given in
	// `ahekas`
	epochProvision = epochProvision.Mul(sdk.NewDecFromInt(hekastypes.PowerReduction))
