...
import (
	...
	"github.com/hekas-network/hekas/x/ibc/transfer/keeper"
	...
	testCases := []struct {
	...
	}{
		{
			...
			func() *types.MsgTransfer {
				...
				transferMsg := types.NewMsgTransfer("transfer", "channel-0", sdk.NewCoin("ahekas", sdk.NewInt(10)), senderAcc.String(), "", timeoutHeight, 0, "")

				coins := sdk.NewCoins(sdk.NewCoin("ahekas", sdk.NewInt(10)))
