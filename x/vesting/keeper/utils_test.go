...
import (
	...
	cosmosante "github.com/hekas-network/hekas/app/ante/cosmos"
	evmante "github.com/hekas-network/hekas/app/ante/evm"
	...
	"github.com/hekas-network/hekas/x/vesting/types"
...
func (suite *KeeperTestSuite) DoSetupTest(t require.TestingT) {
	...
	header := testutil.NewHeader(
		1, time.Now().UTC(), "hekas_9899-1", suite.consAddress, nil, nil,
	)
...
func delegate(clawbackAccount *types.ClawbackVestingAccount, amount sdkmath.Int) error {
	...
	val, err := sdk.ValAddressFromBech32("hekasvaloper1z3t55m0l9h0eupuz3dp5t5cypyv674jjga0d0z")
	s.Require().NoError(err)
