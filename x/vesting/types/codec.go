...
const (
	// Amino names
	clawback                     = "hekas/MsgClawback"
	createClawbackVestingAccount = "hekas/MsgCreateClawbackVestingAccount"
	updateVestingFunder          = "hekas/MsgUpdateVestingFunder"
	convertVestingAccount        = "hekas/MsgConvertVestingAccount"
)
