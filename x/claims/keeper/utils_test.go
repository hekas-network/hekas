...
func newEthAccount(baseAccount *authtypes.BaseAccount) hekastypes.EthAccount {
	return hekastypes.EthAccount{
...
func govProposal(priv *ethsecp256k1.PrivKey) (uint64, error) {
	...
	content := incentivestypes.NewRegisterIncentiveProposal(
		...
		sdk.DecCoins{sdk.NewDecCoinFromDec(utils.BaseDenom, sdk.NewDecWithPrec(625, 5))},
		1000,
	)
