...
// source: hekas/claims/v1/claims.proto
...
func (Action) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8938564c0e95f7b7, []int{0}
}
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=hekas.claims.v1.Action" json:"action,omitempty"`
...
func (*ClaimsRecordAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_8938564c0e95f7b7, []int{1}
}
...
func (*ClaimsRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_8938564c0e95f7b7, []int{2}
}
...
func init() {
	proto.RegisterEnum("hekas.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "hekas.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "hekas.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "hekas.claims.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("hekas/claims/v1/claims.proto", fileDescriptor_8938564c0e95f7b7) }

var fileDescriptor_8938564c0e95f7b7 = []byte{
	...
	,
}
