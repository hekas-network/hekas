...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "hekas.claims.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "hekas.claims.v1.V3Params")
}

func init() { proto.RegisterFile("hekas/claims/v1/genesis.proto", fileDescriptor_f2f8f1d6f18af278) }
