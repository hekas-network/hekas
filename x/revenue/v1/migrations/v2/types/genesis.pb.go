...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "hekas.revenue.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "hekas.revenue.v1.V2Params")
}

func init() { proto.RegisterFile("hekas/revenue/v1/genesis.proto", fileDescriptor_649d64d9c3438055) }
