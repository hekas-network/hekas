...
const (
	// Amino names
	cancelRevenueName   = "hekas/MsgCancelRevenue"
	registerRevenueName = "hekas/MsgRegisterRevenue"
	updateRevenueName   = "hekas/MsgUpdateRevenue"
	updateParamsName    = "hekas/MsgUpdateParams"
)
