	...
	testCases := []struct {
	...
	}{
		{
			...
			banktypes.Metadata{
				...
				Name:        "Hekas",
				Symbol:      "HEKAS",
				Description: "EVM, staking and governance denom of Hekas",
				DenomUnits: []*banktypes.DenomUnit{
					{
						Denom:    "ahekas",
						Exponent: 0,
						Aliases:  []string{"atto hekas"},
					},
					{
						Denom:    "hekas",
						Exponent: 18,
...
func TestEqualAliases(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			[]string{"atto hekas", "ahekas"},
			[]string{"ahekas", "atto hekas"},
			false,
		},
		{
			"same values, sorted",
