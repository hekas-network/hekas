...
// source: hekas/V2Incentives/v1/genesis.proto
...
func init() {
	proto.RegisterType((*V2GenesisState)(nil), "hekas.V2Incentives.v1.V2GenesisState")
	proto.RegisterType((*V2Params)(nil), "hekas.V2Incentives.v1.V2Params")
}

func init() {
	proto.RegisterFile("hekas/V2Incentives/v1/genesis.proto", fileDescriptor_7bb1f7c7e8ad160b)
}
