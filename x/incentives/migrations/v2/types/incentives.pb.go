...
// source: hekas/V2Incentives/v1/V2Incentives.proto
...
func init() {
	proto.RegisterType((*V2Incentive)(nil), "hekas.V2Incentives.v1.V2Incentive")
	proto.RegisterType((*V2GasMeter)(nil), "hekas.V2Incentives.v1.V2GasMeter")
	proto.RegisterType((*RegisterV2IncentiveProposal)(nil), "hekas.V2Incentives.v1.RegisterV2IncentiveProposal")
	proto.RegisterType((*CancelV2IncentiveProposal)(nil), "hekas.V2Incentives.v1.CancelV2IncentiveProposal")
}

func init() {
	proto.RegisterFile("hekas/V2Incentives/v1/V2Incentives.proto", fileDescriptor_95b81e40854aec77)
}
